MAP_MAPPING =	{
    --SPIRAL MOUNTAIN
    ["0xaf"]  = {"Isle O' Hags", "Spiral Mountain"},	--SM - Spiral Mountain
    ["0x173"] =	{"Isle O' Hags", "Spiral Mountain"},	--SM - Banjo's House
	  ["0xae"]  =	{"Isle O' Hags", "Spiral Mountain"},	--SM - Behind the waterfall
	  ["0xad"]  =	{"Isle O' Hags", "Spiral Mountain"},	--SM - Grunty's Lair
	  ["0x141"] =	{"Isle O' Hags", "Spiral Mountain"},	--SM - Inside the Digger Tunnel
	
    --JINJO VILLAGE
    ["0x142"] =	{"Isle O' Hags", "Jinjo Village"},      --JV
	  ["0x146"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Black Jinjo's house
	  ["0x148"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Blue Jinjo's house
	  ["0x143"] =	{"Isle O' Hags", "Jinjo Village"},      --JV - Bottles' House
	  ["0x14a"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Brown Jinjo's house
	  ["0x145"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Green Jinjo's house
	  ["0x19b"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Jingaling's Zombified Palace
	  ["0x144"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Jingaling's Throne Room
	  ["0x14b"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Orange Jinjo's house
    ["0x14c"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Purple Jinjo's house
    ["0x14d"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Red Jinjo's house
    ["0x14e"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - White Jinjo's house
    ["0x147"] =	{"Isle O' Hags", "Jinjo Village"},	    --JV - Yellow Jinjo's house

    --ISLE O' HAGS
    ["0x155"] =	{"Isle O' Hags", "Cliff Top"},          --IoH - Cliff Top
    ["0x156"] =	{"Isle O' Hags", "Cliff Top"},          --IoH - Cliff Top - Mumbo's Skull
    ...
    --MAYAHEM TEMPLE
    ["0xb8"] =	{"Mayahem Temple", "Main Area"},                  --MT
    ["0xbc"] =	{"Mayahem Temple", "Jade Snake Grove"},           --MT - Code Chamber
    ["0xba"] =	{"Mayahem Temple", "Prison Compound"},            --MT - Columns Vault
    ["0x178"] =	{"Mayahem Temple", "Inside Targitzan's Temple"},  --MT - Inside Tatgitzan's Temple
    ["0xc4"] =	{"Mayahem Temple", "Jade Snake Grove"},           --MT - Jade Snake Grove
    ["0xc6"] =	{"Mayahem Temple", "Main Area"},                  --MT - Kickball Arena 1
    ["0xc8"] =	{"Mayahem Temple", "Main Area"},                  --MT - Kickball Arena 2
    ["0xc9"] =	{"Mayahem Temple", "Main Area"},                  --MT - Kickball Arena 3
    ["0x17f"] =	{"Mayahem Temple", "Main Area"},                  --MT - Kickball Arena 4
    ["0xbb"] =	{"Mayahem Temple", "Main Area"},                  --MT - Mayan Kickball Stadium (Lobby)
    ["0xb7"] =	{"Mayahem Temple", "Main Area"},                  --MT - Mumbo's Skull
    ["0xb9"] =	{"Mayahem Temple", "Prison Compound"},            --MT - Prison Compound
    ["0x17a"] =	{"Mayahem Temple", "Inside Targitzan's Temple"},  --MT - Targitzan's Really Sacred Chamber
    ["0x177"] =	{"Mayahem Temple", "Inside Targitzan's Temple"},  --MT - Targitzan's Slightly Sacred Chamber
    ["0x179"] =	{"Mayahem Temple", "Targitzan's Temple Lobby"},   --MT - Targitzan's Temple Lobby
  ...
  --["0xd0"] =	{"Glitter Gulch Mine", "Main Area"},        --GGM - Chuffy's Cab
    ...
    ["0xcc"] =	{"Glitter Gulch Mine", "Flooded Caves"},    --GGM - Flooded Caves
  ...
  --["0x121"] =	{"Glitter Gulch Mine", "Main Area"},        --GGM - Inside Chuffy's Wagon
    ...
    ["0xf8"] =	{"Jolly Roger's Lagoon", "Sea Bottom"},       --JRL - Inside the Big Fish
    ["0xf1"] =	{"Jolly Roger's Lagoon", "Main Area"},        --JRL - Inside the UFO
    ["0xed"] =	{"Jolly Roger's Lagoon", "Main Area"},        --JRL - Jolly's
    ["0xfc"] =	{"Jolly Roger's Lagoon", "Sea Bottom"},       --JRL - Lord Woo Fak Fak
    ["0xef"] =	{"Jolly Roger's Lagoon", "Main Area"},        --JRL - Mumbo's Skull
    ["0xee"] =	{"Jolly Roger's Lagoon", "Main Area"},        --JRL - Pawno's Emporium
    ["0x1a9"] =	{"Jolly Roger's Lagoon", "Sea Bottom"},       --JRL - Sea Bottom
    ["0x181"] =	{"Jolly Roger's Lagoon", "Sea Bottom"},       --JRL - Sea Botom Cavern
    ["0xf7"] =	{"Jolly Roger's Lagoon", "Seaweed Sanctum"},  --JRL - Seaweed Sanctum
  ...
  --["0x105"] =	{"Grunty Industries", "Floor 1"},                 --GI - Elevator shaft
    ...
    ["0x132"] =	{"Hailfire Peaks", "Icicle Grotto"},                --HFP - Icicle Grotto
